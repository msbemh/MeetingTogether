...
import com.example.meetingtogether.databinding.ActivityParticipateMeetingBinding;
...
public class ParticipateMeetingActivity extends AppCompatActivity {
    ...
    private ActivityResultLauncher meetingPermissionLauncher = registerForActivityResult(new ActivityResultContracts.RequestMultiplePermissions(), new ActivityResultCallback<Map<String, Boolean>>() {
        ...
        public void onActivityResult(Map<String, Boolean> result) {
            ...
            // 모든 권한에 동의 하지 않음
                ...
                Toast.makeText(ParticipateMeetingActivity.this, "카메라 권한이 필요합니다.", Toast.LENGTH_SHORT).show();
                finish();
            }
        }
    });
    ...
    private void showToast(final String text) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(ParticipateMeetingActivity.this, text, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityParticipateMeetingBinding.inflate(getLayoutInflater());
        ...
        // 뷰 트리 옵저버 생성
//        ViewTreeObserver viewTreeObserver = binding.framelayouyt.getViewTreeObserver();
//
//        // 뷰 트리 옵저버에 OnPreDrawListener 추가
//        viewTreeObserver.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
//            @Override
//            public boolean onPreDraw() {
//                /** 프레임 레이아웃 width, height 같게 설정 */
//                int width = (int) binding.framelayouyt.getWidth();
//                int height = (int) width;
//
//                if(width != height){
//                    ConstraintLayout.LayoutParams layoutParams = (ConstraintLayout.LayoutParams) binding.framelayouyt.getLayoutParams();
//                    layoutParams.width = width;
//                    layoutParams.height = height;
//
//                    binding.framelayouyt.setLayoutParams(layoutParams); // 레이아웃 파라미터 적용
//                }
//
//                // 작업이 완료되면 true를 반환합니다.
//                return true;
//            }
//        });
        ...
        meetingDTO = gson.fromJson(jsonString, MeetingDTO.class);
        ...
        binding.meetingStartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                /** 미팅 회의 시작 */
                Intent intent = new Intent(ParticipateMeetingActivity.this, MeetingRoomActivity.class);
...
//            }
    ...
    private void openCamera(int width, int height) {
        if (ContextCompat.checkSelfPermission(ParticipateMeetingActivity.this, Manifest.permission.CAMERA)
        ...
        try {
            ...
            if (ActivityCompat.checkSelfPermission(ParticipateMeetingActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(ParticipateMeetingActivity.this, "카메라 권한이 없습니다.", Toast.LENGTH_SHORT).show();
                return;
            }
